...
<aside class="main-sidebar sidebar-dark-primary elevation-4 text-sm">
    ...
    <a class="brand-link" href="index.php">
        <img class="logo-admin-img brand-image" src="assets/images/vinasoftware.png" alt="VinaSorfWare ">
    </a>
                                ...
                                <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                                    ...
                                    <ul class="nav nav-treeview">
                                        ...
                                        <?php if(isset($v['chatlieu']) && $v['chatlieu'] == true) {
                                            ...
                                            <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_chatlieu&type=<?=$k?>" title="Danh mục chất liệu"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Danh mục chất liệu</p></a></li>
                                        <?php } ?>
                                        <?php
                                        $none = "";
                                        $active = "";
                        ...
                        <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <?php if(isset($v['chatlieu']) && $v['chatlieu'] == true) {
                                    ...
                                    <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_chatlieu&type=<?=$k?>" title="Danh mục chất liệu"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Danh mục chất liệu</p></a></li>
                                <?php } ?>
                                <?php if(isset($v['somat']) && $v['somat'] == true) {
                                    $none = "";
                                    $active = "";
                                    if(isset($kiemtra) && $kiemtra == true) if($func->check_access('product', 'man_somat', $k, null, 'phrase-1')) $none = "d-none";
                                    if($com=='product' && ($act=='man_somat' || $act=='add_somat' || $act=='edit_somat') && $k==$_GET['type']) $active = "active"; ?>
                                    <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_somat&type=<?=$k?>&type2=somat" title="Danh mục số mặt"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Danh mục số mặt</p></a></li>
                                <?php } ?>

                                <?php if(isset($v['canmang']) && $v['canmang'] == true) {
                                    $none = "";
                                    $active = "";
                                    if(isset($kiemtra) && $kiemtra == true) if($func->check_access('product', 'man_canmang', $k, null, 'phrase-1')) $none = "d-none";
                                    if($com=='product' && ($act=='man_canmang' || $act=='add_canmang' || $act=='edit_canmang') && $k==$_GET['type']) $active = "active"; ?>
                                    <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_canmang&type=<?=$k?>" title="Danh mục cán màng"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Danh mục cán màng</p></a></li>
                                <?php } ?>

                                <?php if(isset($v['khoanlo']) && $v['khoanlo'] == true) {
                                    $none = "";
                                    $active = "";
                                    if(isset($kiemtra) && $kiemtra == true) if($func->check_access('product', 'man_khoanlo', $k, null, 'phrase-1')) $none = "d-none";
                                    if($com=='product' && ($act=='man_khoanlo' || $act=='add_khoanlo' || $act=='edit_khoanlo') && $k==$_GET['type']) $active = "active"; ?>
                                    <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_khoanlo&type=<?=$k?>" title="Danh mục khoan lỗ"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Danh mục khoan lỗ</p></a></li>
                                <?php } ?>

                                <?php if(isset($v['soduongcung']) && $v['soduongcung'] == true) {
                                    $none = "";
                                    $active = "";
                                    if(isset($kiemtra) && $kiemtra == true) if($func->check_access('product', 'man_soduongcung', $k, null, 'phrase-1')) $none = "d-none";
                                    if($com=='product' && ($act=='man_soduongcung' || $act=='add_soduongcung' || $act=='edit_soduongcung') && $k==$_GET['type']) $active = "active"; ?>
                                    <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_soduongcung&type=<?=$k?>" title="Danh mục số đường cứng"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Danh mục số đường cứng</p></a></li>
                                <?php } ?>

                                <?php if(isset($v['hinhdang']) && $v['hinhdang'] == true) {
                                    $none = "";
                                    $active = "";
                                    if(isset($kiemtra) && $kiemtra == true) if($func->check_access('product', 'man_hinhdang', $k, null, 'phrase-1')) $none = "d-none";
                                    if($com=='product' && ($act=='man_hinhdang' || $act=='add_hinhdang' || $act=='edit_hinhdang') && $k==$_GET['type']) $active = "active"; ?>
                                    <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_hinhdang&type=<?=$k?>" title="Danh mục hình dạng"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Danh mục hình dạng</p></a></li>
                                <?php } ?>

                                <?php if(isset($v['cachthuc']) && $v['cachthuc'] == true) {
                                    $none = "";
                                    $active = "";
                                    if(isset($kiemtra) && $kiemtra == true) if($func->check_access('product', 'man_cachthuc', $k, null, 'phrase-1')) $none = "d-none";
                                    if($com=='product' && ($act=='man_cachthuc' || $act=='add_cachthuc' || $act=='edit_cachthuc') && $k==$_GET['type']) $active = "active"; ?>
                                    <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_cachthuc&type=<?=$k?>" title="Danh mục cách thức"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Danh mục cách thức</p></a></li>
                                <?php } ?>

                                <?php if(isset($v['kieube']) && $v['kieube'] == true) {
                                    $none = "";
                                    $active = "";
                                    if(isset($kiemtra) && $kiemtra == true) if($func->check_access('product', 'man_kieube', $k, null, 'phrase-1')) $none = "d-none";
                                    if($com=='product' && ($act=='man_kieube' || $act=='add_kieube' || $act=='edit_kieube') && $k==$_GET['type']) $active = "active"; ?>
                                    <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_kieube&type=<?=$k?>" title="Danh mục số đường cấn"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Danh mục số đường cấn</p></a></li>
                                <?php } ?>

                                <?php if(isset($v['soluong']) && $v['soluong'] == true) {
                                    $none = "";
                                    $active = "";
                                    if(isset($kiemtra) && $kiemtra == true) if($func->check_access('product', 'man_soluong', $k, null, 'phrase-1')) $none = "d-none";
                                    if($com=='product' && ($act=='man_soluong' || $act=='add_soluong' || $act=='edit_soluong') && $k==$_GET['type']) $active = "active"; ?>
                                    <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_soluong&type=<?=$k?>" title="Danh mục số lượng"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Danh mục số lượng</p></a></li>
                                <?php } ?>
                                <?php
                                $none = "";
                                $active = "";
                        ...
                        <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <?php if(isset($v['size']) && $v['size'] == true) {
                                    ...
                                    if(isset($kiemtra) && $kiemtra == true) if($func->check_access('product', 'man_size', $k, null, 'phrase-1')) $none = "d-none";
                                    if($com=='product' && ($act=='man_size' || $act=='add_size' || $act=='edit_size') && $k==$_GET['type']) $active = "active"; ?>
                                    <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_size&type=<?=$k?>" title="1.Danh mục kích thước"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>1.Danh mục kích thước</p></a></li>
                                <?php } ?>
                                ...
                                <?php if(isset($v['chatlieu']) && $v['chatlieu'] == true) {
                                    ...
                                    if(isset($kiemtra) && $kiemtra == true) if($func->check_access('product', 'man_chatlieu', $k, null, 'phrase-1')) $none = "d-none";
                                    if($com=='product' && ($act=='man_chatlieu' || $act=='add_chatlieu' || $act=='edit_chatlieu') && $k==$_GET['type']) $active = "active"; ?>
                                    <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_chatlieu&type=<?=$k?>&type2=chatlieu" title="2.Danh mục chất liệu giấy"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>2.Danh mục chất liệu giấy</p></a></li>
                                <?php } ?>
                                <?php if(isset($v['somat']) && $v['somat'] == true) {
                                    $none = "";
                                    $active = "";
                                    if(isset($kiemtra) && $kiemtra == true) if($func->check_access('product', 'man_somat', $k, null, 'phrase-1')) $none = "d-none";
                                    if($com=='product' && ($act=='man_somat' || $act=='add_somat' || $act=='edit_somat') && $k==$_GET['type']) $active = "active"; ?>
                                    <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_somat&type=<?=$k?>&type2=somat" title="3.Danh mục số mặt in"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>3.Danh mục số mặt in</p></a></li>
                                <?php } ?>
                                ...
                                <?php if(isset($v['canmang']) && $v['canmang'] == true) {
                                    ...
                                    if(isset($kiemtra) && $kiemtra == true) if($func->check_access('product', 'man_canmang', $k, null, 'phrase-1')) $none = "d-none";
                                    if($com=='product' && ($act=='man_canmang' || $act=='add_canmang' || $act=='edit_canmang') && $k==$_GET['type']) $active = "active"; ?>
                                    <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_canmang&type=<?=$k?>&type2=canmang" title="4.Danh mục loại màng cán"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>4.Danh mục loại màng cán</p></a></li>
                                <?php } ?>
                                ...
                                <?php if(isset($v['khoanlo']) && $v['khoanlo'] == true) {
                                    ...
                                    if(isset($kiemtra) && $kiemtra == true) if($func->check_access('product', 'man_khoanlo', $k, null, 'phrase-1')) $none = "d-none";
                                    if($com=='product' && ($act=='man_khoanlo' || $act=='add_khoanlo' || $act=='edit_khoanlo') && $k==$_GET['type']) $active = "active"; ?>
                                    <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_khoanlo&type=<?=$k?>&type2=khoanlo" title="5.Danh mục đóng số nhảy"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>5.Danh mục đóng số nhảy</p></a></li>
                                <?php } ?>
                                ...
                                <?php if(isset($v['soduongcung']) && $v['soduongcung'] == true) {
                                    ...
                                    if(isset($kiemtra) && $kiemtra == true) if($func->check_access('product', 'man_soduongcung', $k, null, 'phrase-1')) $none = "d-none";
                                    if($com=='product' && ($act=='man_soduongcung' || $act=='add_soduongcung' || $act=='edit_soduongcung') && $k==$_GET['type']) $active = "active"; ?>
                                    <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_soduongcung&type=<?=$k?>&type2=soduongcung" title="6.Danh mục qui cách"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>6.Danh mục qui cách</p></a></li>
                                <?php } ?>
                                <?php if(isset($v['soluong']) && $v['soluong'] == true) {
                                    $none = "";
                                    $active = "";
                                    if(isset($kiemtra) && $kiemtra == true) if($func->check_access('product', 'man_soluong', $k, null, 'phrase-1')) $none = "d-none";
                                    if($com=='product' && ($act=='man_soluong' || $act=='add_soluong' || $act=='edit_soluong') && $k==$_GET['type']) $active = "active"; ?>
                                    <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_soluong&type=<?=$k?>&type2=soluong" title="7.Danh mục số lượng"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>7.Danh mục số lượng</p></a></li>
                                <?php } ?>
                                <?php if(isset($v['hinhdang']) && $v['hinhdang'] == true) {
                                    $none = "";
                                    $active = "";
                                    if(isset($kiemtra) && $kiemtra == true) if($func->check_access('product', 'man_hinhdang', $k, null, 'phrase-1')) $none = "d-none";
                                    if($com=='product' && ($act=='man_hinhdang' || $act=='add_hinhdang' || $act=='edit_hinhdang') && $k==$_GET['type']) $active = "active"; ?>
                                    <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_hinhdang&type=<?=$k?>&type2=hinhdang" title="8.Danh mục thời gian"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>8.Danh mục thời gian</p></a></li>
                                <?php } ?>
                                ...
                                <?php if(isset($v['cachthuc']) && $v['cachthuc'] == true) {
                                    ...
                                    if(isset($kiemtra) && $kiemtra == true) if($func->check_access('product', 'man_cachthuc', $k, null, 'phrase-1')) $none = "d-none";
                                    if($com=='product' && ($act=='man_cachthuc' || $act=='add_cachthuc' || $act=='edit_cachthuc') && $k==$_GET['type']) $active = "active"; ?>
                                    <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_cachthuc&type=<?=$k?>&type2=cachthuc" title="9.Danh mục số lượng trang ruột"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>9.Danh mục số lượng trang ruột</p></a></li>
                                <?php } ?>
                                ...
                                <?php if(isset($v['kieube']) && $v['kieube'] == true) {
                                    ...
                                    if(isset($kiemtra) && $kiemtra == true) if($func->check_access('product', 'man_kieube', $k, null, 'phrase-1')) $none = "d-none";
                                    if($com=='product' && ($act=='man_kieube' || $act=='add_kieube' || $act=='edit_kieube') && $k==$_GET['type']) $active = "active"; ?>
                                    <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_kieube&type=<?=$k?>&type2=kieube" title="10.Danh mục số đường cấn"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>10.Danh mục số đường cấn</p></a></li>
                                <?php } ?>
