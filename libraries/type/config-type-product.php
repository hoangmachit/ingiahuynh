...
$config['product'][$nametype]['chatlieu'] = true;
$config['product'][$nametype]['somat'] = true;
$config['product'][$nametype]['canmang'] = true;
$config['product'][$nametype]['khoanlo'] = true;
$config['product'][$nametype]['soduongcung'] = true;
$config['product'][$nametype]['hinhdang'] = true;
$config['product'][$nametype]['cachthuc'] = true;
$config['product'][$nametype]['price'] = true;
$config['product'][$nametype]['kieube'] = true;
$config['product'][$nametype]['soluong'] = true;
