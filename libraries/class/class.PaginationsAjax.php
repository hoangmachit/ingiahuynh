		...
		function getAllPageLinks($count, $href, $elShow)
		{
			...
			if($pages>1)
			{
				...
				// else	
					...
					$output = $output . '<a class="prev" onclick="loadPagingAjax(\'' . $href . ($_GET["p"]-1) . '\',\''.$elShow.'\')" ><i class="fa fa-chevron-left"></i></a>';
				...
				// else				
					...
					$output = $output . '<a class="last disabled"><i class="fa fa-chevron-right"></i></a>';
