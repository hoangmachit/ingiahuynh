			...
			<div class="card card-primary card-outline text-sm">
				...
				<div class="card-body">
					<div class="form-group">
						<?php if (isset($config['website']['mailhost']) && $config['website']['mailhost'] == true) { ?>
							<div class="custom-control custom-radio d-inline-block mr-3 text-md">
								<input class="custom-control-input mailertype" type="radio" id="mailertype-host" name="data[options][mailertype]" <?= ($options['mailertype'] == 1) ? "checked" : "" ?> value="1">
								<label for="mailertype-host" class="custom-control-label font-weight-normal">Host email</label>
							</div>
						<?php } ?>
						<div class="custom-control custom-radio d-inline-block mr-3 text-md">
							<input class="custom-control-input mailertype" type="radio" id="mailertype-gmail" name="data[options][mailertype]" <?= ($options['mailertype'] == 2 ||  $config['website']['mailhost'] == false) ? "checked" : "" ?> value="2">
							<label for="mailertype-gmail" class="custom-control-label font-weight-normal">Gmail email</label>
						</div>
					</div>
					<?php if (isset($config['website']['mailhost']) && $config['website']['mailhost'] == true) { ?>
						<div class="host-email <?= ($options['mailertype'] == 1) ? 'd-block' : 'd-none' ?>">
							<div class="row">
					...
					<?php } ?>
					<div class="gmail-email <?= ($options['mailertype'] == 2 ||  $config['website']['mailhost'] == false) ? 'd-block' : 'd-none' ?>">
						<div class="row">
							<div class="form-group col-md-4 col-sm-6">
							...
							<div class="form-group col-md-4 col-sm-6">
								...
								<select class="form-control" name="data[options][secure_gmail]" id="secure_gmail">
									<option <?= ($options['secure_gmail'] == 'tls') ? 'selected' : '' ?> value="tls" disabled>TLS</option>
									<option <?= ($options['secure_gmail'] == 'ssl') ? 'selected' : '' ?> value="ssl" disabled>SSL</option>
								</select>
							</div>
							<div class="form-group col-md-4 col-sm-6">
