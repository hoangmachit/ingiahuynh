...
$router->map('GET',array('adminvns/','adminvns'), function(){
	global $func, $config;
	$func->redirect($config['database']['url']."adminvns/index.php");
	exit;
});
$router->map('GET',array('adminvns','adminvns'), function(){
	global $func, $config;
...
$requick = array(
	/* Sản phẩm */
	array("tbl"=>"product_list","field"=>"idl","source"=>"product","com"=>"an-pham","type"=>"an-pham"),
	array("tbl"=>"product_cat","field"=>"idc","source"=>"product","com"=>"an-pham","type"=>"an-pham"),
		array("tbl"=>"product_item","field"=>"idi","source"=>"product","com"=>"an-pham","type"=>"an-pham"),
		// array("tbl"=>"product_sub","field"=>"ids","source"=>"product","com"=>"an-pham","type"=>"an-pham"),
		// array("tbl"=>"product_brand","field"=>"idb","source"=>"product","com"=>"thuong-hieu","type"=>"an-pham"),
	array("tbl"=>"product","field"=>"id","source"=>"product","com"=>"an-pham","type"=>"an-pham",'menu'=>true),

	array("tbl"=>"product_list","field"=>"idl","source"=>"product","com"=>"cua-hang","type"=>"cua-hang"),
	array("tbl"=>"product_cat","field"=>"idc","source"=>"product","com"=>"cua-hang","type"=>"cua-hang"),
	array("tbl"=>"product","field"=>"id","source"=>"product","com"=>"cua-hang","type"=>"cua-hang",'menu'=>true),
	/* Tin tức */
	...
	array("tbl"=>"static","field"=>"id","source"=>"static","com"=>"tuyen-dung","type"=>"tuyen-dung"),
	...
	/* Tags */
		// array("tbl"=>"tags","tbltag"=>"product","field"=>"id","source"=>"tags","com"=>"tags-an-pham","type"=>"an-pham",'menu'=>true),
