<?php
    ...
    $config['news'][$nametype]['width'] = 36;
    $config['news'][$nametype]['height'] = 36;
    $config['news'][$nametype]['thumb'] = '36x36x1';
    $config['news'][$nametype]['img_type'] = '.jpg|.gif|.png|.jpeg|.gif|.JPG|.PNG|.JPEG|.Png|.GIF';

    /* Tư vấn đặt hàng */
    $nametype = "tu-van-dat-hang";
    $config['news'][$nametype]['title_main'] = "Tư vấn đặt hàng";
    $config['news'][$nametype]['check'] = array();
    $config['news'][$nametype]['view'] = true;
    $config['news'][$nametype]['mota'] = true;
     ...
     $config['news'][$nametype]['seo'] = false;
     $config['news'][$nametype]['width'] = 154;
     $config['news'][$nametype]['height'] = 154;
     $config['news'][$nametype]['thumb'] = '80x80x1';
     $config['news'][$nametype]['img_type'] = '.jpg|.gif|.png|.jpeg|.gif|.JPG|.PNG|.JPEG|.Png|.GIF';
