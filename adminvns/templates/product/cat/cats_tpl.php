<?php
	$linkMan = $linkFilter = "index.php?com=product&act=man_cat&type=".$type."&p=1";
	$linkAdd = "index.php?com=product&act=add_cat&type=".$type."&p=1";
    $linkEdit = "index.php?com=product&act=edit_cat&type=".$type."&p=1";
    $linkDelete = "index.php?com=product&act=delete_cat&type=".$type."&p=1";
?>
<!-- Content Header -->
