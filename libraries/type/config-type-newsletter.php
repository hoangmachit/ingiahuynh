<?php
    /* Đăng ký nhận tin */
    $nametype = "dat-in";
    $config['newsletter'][$nametype]['title_main'] = "Đặt in nhận tin";
    ...
    $config['newsletter'][$nametype]['sanpham'] = true;
    $config['newsletter'][$nametype]['kichthuoc'] = true;
    $config['newsletter'][$nametype]['chatlieu'] = true;
    $config['newsletter'][$nametype]['somat'] = true;
    $config['newsletter'][$nametype]['canmang'] = true;
    $config['newsletter'][$nametype]['khoanlo'] = true;
    $config['newsletter'][$nametype]['soduongcung'] = true;
    $config['newsletter'][$nametype]['hinhdang'] = true;
    $config['newsletter'][$nametype]['cachthuc'] = true;
    $config['newsletter'][$nametype]['kieube'] = true;
    $config['newsletter'][$nametype]['soluong'] = true;
    $config['newsletter'][$nametype]['gia'] = true;
