<div class="w-clear">
    <div class="row">
        ...
        <div class="col-md-5 col-12 ">
            <h2 class="contact-title"><?= lienhevoichungtoi ?></h2>
...
<style>
    ...
    .input-contact input {
        ...
        background-image: url("./assets/img/icon-c1.png");
    }

    .form-contact .row:nth-child(1) .input-contact:nth-child(2) input {
        background-image: url("./assets/img/icon-c2.png");
    }

    .form-contact .row:nth-child(2) .input-contact:nth-child(1) input {
        background-image: url("./assets/img/icon-c3.png");
    }

    .form-contact .row:nth-child(2) .input-contact:nth-child(2) input {
        background-image: url("./assets/img/icon-c4.png");
    }
    ...
    .input-contact textarea:-moz-placeholder,
