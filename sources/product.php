...
else if($idl!='')
{
	...
	$productshowlist = $d->rawQuery("select id, ten$lang as ten, tenkhongdauvi, tenkhongdauen, type, photo, options from #_product_cat where id_list = ? and type = ? order by stt,id desc",array($idl,$type));
...
else if($idc!='')
{
	...
	$productshowlist = $d->rawQuery("select id, ten$lang as ten, tenkhongdauvi, tenkhongdauen, type, photo, options from #_product_item where id_cat = ? and type = ? order by stt,id desc",array($idc,$type));
